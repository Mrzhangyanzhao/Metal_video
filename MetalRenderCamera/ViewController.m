...
@property (assign, nonatomic) int sigma;
@end
...
- (void)drawInMTKView:(MTKView *)view {
    ...
    if (self.texture) {
        ...
        MPSImageGaussianBlur *filter = [[MPSImageGaussianBlur alloc] initWithDevice:self.mtkView.device sigma:self.sigma];
...
-(IBAction)sliderValueChange:(UISlider *)sender{
    self.sigma = floorf(sender.value);
    NSLog(@"%d",self.sigma);
}
